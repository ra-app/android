...
import org.raapp.messenger.ConfirmIdentityDialog;
import org.raapp.messenger.MediaPreviewActivity;
import org.raapp.messenger.MessageDetailsActivity;
...
import org.raapp.messenger.components.ConversationItemThumbnail;
import org.raapp.messenger.components.DocumentView;
import org.raapp.messenger.components.LinkPreviewView;
import org.raapp.messenger.components.QuoteView;
import org.raapp.messenger.components.SharedContactView;
import org.raapp.messenger.components.StickerView;
...
import org.raapp.messenger.util.LongClickCopySpan;
import org.raapp.messenger.util.LongClickMovementMethod;
  ...
  private void setAudioViewTint(MessageRecord messageRecord, Recipient recipient) {
    if (messageRecord.isOutgoing()) {
      if (DynamicTheme.LIGHT.equals(TextSecurePreferences.getTheme(context))) {
        audioViewStub.get().setTint(getContext().getResources().getColor(R.color.white), defaultBubbleColor);
      } else {
