...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.raapp.provider.messenger.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("org.raapp.provider.messenger.mms", "mms/#", SINGLE_ROW);
  }
